...
namespace McRenderFace {
    ...
    void PathTracer::render(McRenderFace::SimpleScene &scene, McRenderFace::RenderTarget &target) {
...
//                    return if any intersection exists
    ...
    bool PathTracer::traceShadow(SimpleScene &scene, float lightDistance, const Ray &ray) {
        RayHit hit;
        int index = -1;
